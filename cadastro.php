    ...
    <div class="row">
        ...
        <div class="col-lg-11 col-md-10 col-sm-9 col-xs-12 menu-direito">
            ...
            <form action="" method="" class="formularioCadastro">
                <div class="container">
                    <h3 class="formularioDisciplina">Cadastro de disciplina</h3>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            ...
                            <input type="text" id="nome" class="form-control inputFormulario" placeholder="Nome" maxlength="50">
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <label class="textoFormulario" for="conteudo">Conteúdo:</label>
                            <input type="text" id="conteudo" class="form-control inputFormulario" placeholder="Conteúdo" maxlength="50">
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
